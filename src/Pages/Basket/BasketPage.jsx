  ...
  return (
    <>
      {listCart.length >= 1 ? (
        ...
        >
                          ...
                          <>
                            <Box display="flex">
                              ...
                              <Box flex="0.2">
                                <div
                                  style={{
                                    backgroundImage: `url(${BASE_URL}/files/${productCart.images[0]})`,
          ...
          <Box display="flex" flexDirection="column" gap="40px">
            ...
            <Button
              px="50px"
              w="100%"
              bg={color[color.selected].clr}
              color={color[color.selected].bgClr}
        ...
        >
          <Image w="40%" h="40%" src={emptyCart} />
          <Heading className="font-Digikala">
           سبد خرید خالی است 
          </Heading>
        </Box>
      )}
